...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--model_ckpt",
        type=str,
        default="model_checkpoints/multistep_arithmetic/baselines/llama7b_rationale_l3-4d2-22_5epoch_allsamples_s0/checkpoint-680",
    ...
    get_lmsi_data(
        wrapped_model,
        evaluator,
        ori_path="data/training/multistep_arithmetic/multistep_arithmetic_baseline_rationale_l3-4d2-22.jsonl",
        save_path="data/training/multistep_arithmetic/multistep_arithmetic_LMSI_rationale_l3-4d2-22.jsonl",
        task_type="number",
        debug=args.debug
    )