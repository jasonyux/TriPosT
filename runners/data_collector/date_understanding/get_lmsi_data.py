...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--model_ckpt",
        type=str,
        default="model_checkpoints/date_understanding/baselines/llama7b_rationale_1-2_5epoch_allsamples_s0/checkpoint-240",
    ...
    evaluator = DateUnderstandingEvaluator(
        ...
        subtask="all",
        eval_start_idx=0,
        eval_end_idx=64 if args.debug else None,
        batch=4,
        shuffle=False,
        verbose=False,
    )
